...
import { Upload, FileCode, CheckCircle, AlertCircle, Sparkles, FolderArchive, Layers, GitBranch, Globe } from 'lucide-react';
      ...
      <div className="relative w-full max-w-2xl bg-[#0c101a] border border-cyan-500/30 rounded-2xl p-6 sm:p-8 shadow-2xl space-y-6">
        ...
        <div className="flex items-center justify-between border-b border-slate-800 pb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="font-mono font-bold text-slate-100 text-base">SMART ARTIFACT ANALYSIS CENTER</h2>
              <p className="text-xs text-slate-400 font-mono">Upload project ZIP, code folder, dataset, doc, or GitHub URL.</p>
            </div>
          </div>
        ...
        {/* Tab Switcher */}
        <div className="flex items-center space-x-2 border-b border-slate-800/80 pb-3 font-mono text-xs">
          <button
          ...
          >
            ...
            <span>Upload Archive / Files</span>
          </button>
          ...
          >
            ...
            <span>Import Public GitHub Repo</span>
          </button>
        </div>

        {/* Content by Tab */}
        {activeTab === 'github' ? (
          <GithubImporter onSuccess={onComplete} onCancel={onCancel} />
        ) : (
          <>
            {/* Name Input */}
